/**
 * ConsentGate.tsx
 * Informed consent screen — collects acknowledgment before data collection begins.
 */
      ...
      <div className="max-w-xl w-full">
        ...
        <ul className="space-y-5 mb-10">
          {CONSENT_POINTS.map((point) => (
            <li key={point} className="flex gap-4 text-sm md:text-[15px] text-foreground/75 leading-relaxed">
